...
echo.
set /p panel_port="Enter panel port (default: 2080): "
if "%panel_port%"=="" set "panel_port=2080"

set /p panel_path="Enter panel path (default: /app/): "
if "%panel_path%"=="" set "panel_path=/app/"

set /p sub_port="Enter subscription port (default: 2035): "
if "%sub_port%"=="" set "sub_port=2035"
